export const overviewSkills = [
  {
    title: "Web Developer",
    content: "Web development experties in React, Next, Solid and ThreeJS.",
    color1: "#185a9d",
    color2: "#6dd5ed",
  },
  {
    title: "App Developer",
    content: "Experience with react native and work with node environment.",
    color1: "#cc2b5e",
    color2: "#753a88",
  },
  {
  ...
  },
  {
    ...
    content:
      "Worked with BrainJS and Tensorflow in JavaScript and also worked with ML in python.",
    color1: "#329d9c",
    color2: "#7be495",
  },
];

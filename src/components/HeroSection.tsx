        ...
        <div class="relative pt-8 min-h-[50%]">
          <div class="absolute top-0 left-0">
            <div
              ...
              class="h-5 w-5 mx-auto rounded-full bg-heading opacity-0"
              style={{ "box-shadow": "0px 0px 30px 5px #8f60f8" }}
            />
            <div
              id="herosection-navigator-path-1"
              class="w-1 mx-auto -translate-y-0.5 bg-gradient-to-b from-heading"
              style={{ height: 0 }}
            />
          </div>
        ...
        <div class="relative pt-8 min-h-[50%]">
          <div class="absolute top-0 left-0">
            <div
              ...
              class="h-5 w-5 mx-auto rounded-full bg-white opacity-0"
              style={{ "box-shadow": "0px 0px 30px 5px #ffffff" }}
            />
            <div
              id="herosection-navigator-path-2"
              class="w-1 mx-auto -translate-y-0.5 bg-gradient-to-b from-white"
              style={{ height: 0 }}
            />
          </div>
          <div id="herosection-content-2" class="pl-10 opacity-0 translate-x-5">
            <p class="text-2xl max-w-xs">
              ...
              <span class="text-heading font-semibold">20,000+</span> followers
              on social media in the name of{" "}
              <span class="text-heading font-semibold">Dare2Solve</span> which
